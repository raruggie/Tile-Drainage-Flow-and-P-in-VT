...
levels(t$Site)<-c("AHS", "DCN", "DCS"); levels(t$Season)<-c("G", "NG")

t$SRP.Conc[t$Site == 'AHS' & t$SRP.Conc == 0]<-NA
t$SRP.Load[t$Site == 'AHS' & t$SRP.Load == 0]<-NA
